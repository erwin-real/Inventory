<div class="sidebar-menu">
    <div class="sidebar-header">
        <div class="logo">
            {{--<a href="/" style="max-width: 100% !important; "><img src="{{ asset('assets/images/logo.png') }}" alt="logo"></a>--}}
            <a href="/" style="max-width: 100% !important; text-decoration: none"><h1 class="text-white">Inventory</h1></a>
...
{{--                    @if(Auth::user()->type == 'manager')--}}
                        <li class="{{ request()->is('/') ? 'active border-left-info' : '' }}">
                            <a href="/"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
                        </li>
                    {{--@endif--}}
                    <li class="{{ request()->is('products') || request()->is('products/*') ? 'active border-left-info' : '' }}">
                        <a href="/products"><i class="ti-bag"></i> <span>Products</span></a>
                    </li>
                    <li class="{{ request()->is('transactions') || request()->is('transactions/*') ? 'active border-left-info' : '' }}">
                        <a href="/transactions"><i class="ti-list"></i> <span>Transactions</span></a>
                    </li>
